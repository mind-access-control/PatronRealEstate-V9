        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="siteDescription" defaultValue="Professional real estate services in your area" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="contactEmail">Primary Contact Email</Label>
              <Input id="contactEmail" type="email" defaultValue="patronrealestateservices@gmail.com" />
            </div>
            <div className="space-y-2">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-600">Automatically approve new agent registrations</p>
              </div>
              <Switch />
            </div>
            <div className="flex items-center justify-between">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-600">Automatically publish new property listings</p>
              </div>
              <Switch />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              <Label htmlFor="featuredDuration">Featured Listing Duration (days)</Label>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-gray-600">Notify admins of new leads</p>
              </div>
              <Switch defaultChecked />
            </div>
            <div className="space-y-2">
              <Label htmlFor="adminEmail">Admin Notification Email</Label>
              <Input id="adminEmail" type="email" defaultValue="admin@patronrealestate.com" />
            </div>
          </CardContent>
        </Card>
