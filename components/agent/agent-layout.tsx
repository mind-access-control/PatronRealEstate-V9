...
import { Home, Building2, Users, Calendar, MessageSquare, BarChart3, Settings, Menu, X, User, Bell } from "lucide-react"
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? "block" : "hidden"}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <span className="text-xl font-bold text-emerald-600">Agent Portal</span>
            ...
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center gap-x-2">
                ...
                <div className="flex flex-col">
                  ...
                  <button onClick={() => auth.logout()} className="text-xs text-gray-500 hover:text-gray-700 text-left">
                    Logout
                  </button>
                </div>
              </div>
