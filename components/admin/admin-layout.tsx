...
import { BarChart3, Home, Users, Building, MessageSquare, Settings, LogOut, Menu, X, Bell, Search } from "lucide-react"
                ...
                <DropdownMenuContent className="w-56" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal">
                    <div className="flex flex-col space-y-1">
                      ...
                      <p className="text-xs leading-none text-muted-foreground">admin@patronrealestate.com</p>
                    </div>
                  </DropdownMenuLabel>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem>
                ...
                <li key={item.name}>
                  <Link
                    ...
                    className={`flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-lg transition-colors ${
                      isActive ? "bg-emerald-100 text-emerald-900 border-r-2 border-emerald-600" : "hover:bg-muted"
                    }`}
